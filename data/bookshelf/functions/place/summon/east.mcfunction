...
# Shelf 2
summon minecraft:armor_stand ~-0.3 ~-0.65 ~0 {NoGravity:1b,ShowArms:1b,Invisible:1b,Unbreakable:1b,Small:1b,Pose:{LeftArm:[0f,0f,90f],RightArm:[90f,91f,165f]},DisabledSlots:1973790,Rotation:[180f],Tags:["chk.bookshelf","chk.shelf2","chk.shelf_east","chk.main_shelf"]}
# Shelf 1
