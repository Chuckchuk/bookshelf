...
execute if score #bb.pos.x bb.calculation matches 3..8 if score #bb.pos.y bb.calculation matches 0..16 if score #bb.pos.z bb.calculation matches 0..16 run function bookshelf:player/facing/success
